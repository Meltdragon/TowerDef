...
Amount of enemies is an animationcurve which can hold the amount of enemies in the graphic. It shows the enemies in the list using the time(element 0 in the list is time 0) and how many enemies will be spawned shows the value at that point
